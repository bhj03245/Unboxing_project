...
public class ParkList extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static String list_name = "park";
    ...
    private class GetData extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null) {
                Toast.makeText(ParkList.this, "Error: Network is not ready", Toast.LENGTH_SHORT).show();
            } else {
                mJsonString = result;
                showResult();
            }
        ...
        protected String doInBackground(Void... unused) {
            ...
            try {
                ...
                url = new URL(getString(R.string.ip) + "/apkCtrl/parkList_apk.php");
